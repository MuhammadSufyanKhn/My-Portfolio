...
This is my personal developer portfolio, built to showcase my background in backend engineering with ASP.NET Core, C#, and SQL Server. It covers my education, work experience, projects, technical skills, and certifications, and includes a direct way to get in touch.
...
```bash
git clone https://github.com/MuhammadSufyanKhn/sufyan-portfolio.git
cd sufyan-portfolio
npm install
```
