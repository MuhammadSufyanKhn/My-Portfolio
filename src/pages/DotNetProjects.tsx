    ...
    >
      <div style={{ padding: "28px" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px", marginBottom: "8px" }}>
          ...
          <span style={{ padding: "3px 10px", borderRadius: "100px", background: "rgba(99, 102, 241, 0.12)", border: "1px solid rgba(99, 102, 241, 0.25)", color: "#818cf8", fontSize: "11px", fontWeight: 700, flexShrink: 0 }}>
            .NET
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "24px" }}>
          {project.tech.map((t) => (
            <span key={t} style={{ padding: "4px 11px", borderRadius: "100px", background: "rgba(99, 102, 241, 0.1)", border: "1px solid rgba(99, 102, 241, 0.22)", color: "#818cf8", fontSize: "11px", fontWeight: 600 }}>
              {t}
            </span>
          ))}
        </div>
